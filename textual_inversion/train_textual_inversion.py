...
def parse_args():
    ...
    parser.add_argument(
        "--data_path", type=str, default=None, help="The path to image"
    )
    parser.add_argument(
        "--placeholder_token",
        type=str,
    ...
    if args.train_data_dir is None and args.data_path is None:
...
def main():
    args = parse_args()
    args.validation_prompt = f'a photo of {args.initializer_token}'
